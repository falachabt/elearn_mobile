...
const CustomizableGoals = ({
  isDarkMode,
  toDayXp,
  toDayExo,
  toDayTime,
}: CustomizableGoalsProps) => {
  const { trigger } = useHaptics();
            ...
            >
              <View style={styles.goalIcon}>
                <MaterialCommunityIcons
                  ...
                  size={22}
                  color={
                    isGoalMet ? theme.color.primary[500] : theme.color.error
                  }
                />
              </View>
              <Text
                numberOfLines={2}
                style={isDarkMode ? styles.goalTitleDark : styles.goalTitle}
              >
                {goal.title}
              </Text>
                ...
                <View style={styles.modalSection}>
                  <Text
                    style={[
                      ...
                      isDarkMode && styles.modalSectionTitleDark,
                    ]}
                  >
                  ...
                  <View style={styles.goalValueContainer}>
                    <View
                      style={[
                        ...
                        isDarkMode && styles.modalIconContainerDark,
                      ]}
                    >
                      <MaterialCommunityIcons
                    ...
                    <Text
                      style={[
                        styles.currentGoalText,
                        isDarkMode && styles.currentGoalTextDark,
                      ]}
                    >
                      Objectif actuel: {goals[editingGoal].total}{" "}
                      {goals[editingGoal].unit}
                    </Text>
                  </View>

                  <Text
                    style={[
                      styles.tagSelectorLabel,
                      isDarkMode && styles.tagSelectorLabelDark,
                    ]}
                  >
              ...
              <>
                <ScrollView style={styles.goalsList}>
                  {goals.map((goal, index) => (
                    <Pressable
                      ...
                      style={[
                        styles.goalItem,
                        isDarkMode && styles.goalItemDark,
                      ]}
                      onPress={() => handleEditGoal(index)}
                    >
                        ...
                        <View>
                          <Text
                            style={[
                              ...
                              isDarkMode && styles.goalItemTitleDark,
                            ]}
                          >
                            {goal.title}
                          </Text>
                          <Text
                            style={[
                              ...
                              isDarkMode && styles.goalItemSubtitleDark,
                            ]}
                          >
                ...
                <View style={styles.modalButtonsContainer}>
                  <Pressable
                    style={[
                      styles.resetButton,
                      isDarkMode && styles.resetButtonDark,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        ...
                        isDarkMode && styles.resetButtonTextDark,
                      ]}
                    >
                      Réinitialiser
                    </Text>
