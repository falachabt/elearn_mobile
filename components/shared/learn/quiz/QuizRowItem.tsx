...
import {
  ...
  QUIZ_CATEGORY_ICONS,
} from "@/components/shared/learn/quiz/QuizCategoryFilter";
...
const EnhancedQuizRowItem: React.FC<QuizItemProps> = ({
  quizItem,
  baseRoute,
  isDark = false,
  index = 0,
  ...
  const categoryColor =
    QUIZ_CATEGORY_COLORS[categoryName as keyof typeof QUIZ_CATEGORY_COLORS] ||
    QUIZ_CATEGORY_COLORS.default;
  const categoryIcon = (QUIZ_CATEGORY_ICONS[
    categoryName as keyof typeof QUIZ_CATEGORY_ICONS
  ] || QUIZ_CATEGORY_ICONS.default) as IconName;
          ...
          <View style={styles.quizHeader}>
            ...
            <View style={styles.quizDetails}>
              ...
              <View style={styles.quizInfoRow}>
                <ThemedText
                  style={[styles.quizInfo, isDark && styles.quizInfoDark]}
                >
                  <MaterialCommunityIcons
