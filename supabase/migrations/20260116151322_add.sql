...
alter table "public"."user_competition_payments" add column "has_seen_results" boolean default false;

UPDATE "public"."user_competition_payments" SET has_seen_results = true;
