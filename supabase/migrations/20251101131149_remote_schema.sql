...
ALTER TABLE ONLY "public"."content_interactions"
    ADD CONSTRAINT "content_interactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."accounts"("id");
...
ALTER TABLE ONLY "public"."resource_permissions"
    ADD CONSTRAINT "resource_permissions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."accounts"("id");
...
ALTER TABLE ONLY "public"."staff_invitations"
    ADD CONSTRAINT "staff_invitations_invited_by_fkey" FOREIGN KEY ("invited_by") REFERENCES "public"."accounts"("id");
...
ALTER TABLE ONLY "public"."user_notification_history"
    ADD CONSTRAINT "user_notification_history_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."accounts"("id") ON DELETE CASCADE;
...
CREATE TRIGGER on_auth_user_created AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION handle_new_user();
  ...
  create policy "Give users access to own folder 9mn7xb_0"
  on "storage"."objects"
  as permissive
  for select
...
using (true);
  ...
  create policy "Give users access to own folder 9mn7xb_1"
  on "storage"."objects"
  as permissive
  for insert
  to anon, authenticated
with check (true);
  ...
  create policy "Give users access to own folder 9mn7xb_2"
  on "storage"."objects"
  as permissive
  for update
  to anon, authenticated
using (true);
  ...
  create policy "Give users access to own folder 9mn7xb_3"
  on "storage"."objects"
  as permissive
  for delete
  to anon, authenticated
