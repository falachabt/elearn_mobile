...
const DocumentViewerScreen = () => {
  ...
  // Programme pour afficher le header coh�rent avec la liste
  ...
  // V�rifier que le document actif a un download_url
      ...
      <View style={[styles.titleHeader, isDark && styles.titleHeaderDark]}>
        ...
        <View style={styles.actionButtons}>
          ...
          >
            ...
            >
              {isCompleted ? "Compl�t�" : "Marquer comme compl�t�"}
            </ThemedText>
          </TouchableOpacity>
        </View>
      </View>
