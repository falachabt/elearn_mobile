    ...
    return (
      ...
      >
        ...
        <View style={styles.pathContent}>
          <Text style={[styles.concoursName, isDarkMode && styles.concoursNameDark]}>{concours?.name} . {concours?.school.name}</Text>
          ...
          <View style={styles.progressContainer}>
            ...
            <Text style={[styles.progressText, isDarkMode && styles.progressTextDark]}>{path.progress}% complété</Text>
          </View>

          <View style={[styles.statsContainer, isDarkMode && styles.statsContainerDark]}>
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="book-open-variant" size={20} color={theme.color.primary[500]} />
              <Text style={[styles.statText, isDarkMode && styles.statTextDark]}>{path.course_count} cours</Text>
            </View>
            
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="help-circle" size={20} color={theme.color.primary[500]} />
              <Text style={[styles.statText, isDarkMode && styles.statTextDark]}>{path.quiz_count} quiz</Text>
            </View>

            <View style={styles.statItem}>
              <MaterialCommunityIcons name="clock-outline" size={20} color={theme.color.primary[500]} />
              <Text style={[styles.statText, isDarkMode && styles.statTextDark]}>{path.total_duration}h</Text>
            </View>
          </View>
