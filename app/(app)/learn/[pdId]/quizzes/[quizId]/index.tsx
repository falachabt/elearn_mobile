...
//TODO : impleemnt the quiz pin feature
...
const QuizDetail = () => {
  ...
  } = useSWR<Q>(quizId ? `quiz-${quizId}` : null, async () => {
      ...
      >
        <View style={styles.statsGrid}>
          <StatCard
            ...
            label="Questions"
          />
          <StatCard icon="clock-outline" value={"--"} label="Duration" />
          <StatCard icon="trophy-outline" value="0%" label="Success" />
        </View>
        ...
        <View style={styles.section}>
          ...
          {(showAllPrereqs
            ...
            <Pressable
              ...
              onPress={ ( ) => { router.push(`/(app)/learn/${pdId}/courses/${prereq.courses.id}`) }  }
            >
              <MaterialCommunityIcons
                name="check-circle"
                size={20}
